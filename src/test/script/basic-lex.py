...
invalidFilesPath = "src/test/deca/syntax/invalid/our_lex_tests"
validFileResultsPath = "src/test/deca/syntax/valid/lex-results"
invalidFileResultsPath = "src/test/deca/syntax/invalid/lex-results"
...
print("[LEXER] PASSED TESTS : ", numPass)
print("[LEXER] FAILED TESTS : ", numFail)

if (not(isDebug)):

    print("[LEXER] THE FAILED TESTS ARE : ", failedTests)