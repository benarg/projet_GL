...
public abstract class AbstractIdentifier extends AbstractLValue {
    ...
    /**
     * There is an issue in the parser : 
     *      - the IDENT rule creates a temporary SymbolTable different from the DecacCompiler's SymbolTable
     *      - this is a problem because all symbols must be stored in the same SymbolTable
     *      => as a result, this methods resets the Identifier's symbol by exchanging it for 
     *          an identical symbol present in the DecacCompiler's SymbolTable
     * @param symTable
     */
    public abstract void resetName(SymbolTable symTable);
